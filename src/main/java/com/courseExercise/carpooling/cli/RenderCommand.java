package com.courseExercise.carpooling.cli;

import com.courseExercise.carpooling.CarpoolingConfiguration;
...
public class RenderCommand extends ConfiguredCommand<CarpoolingConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<CarpoolingConfiguration> bootstrap,
                       Namespace namespace,
                       CarpoolingConfiguration configuration) throws Exception {
